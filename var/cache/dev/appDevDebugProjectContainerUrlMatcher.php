...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/priority')) {
            // priority_index
            if (rtrim($pathinfo, '/') === '/priority') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_priority_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'priority_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\PriorityController::indexAction',  '_route' => 'priority_index',);
            }
            not_priority_index:
            ...
            if ($pathinfo === '/priority/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    ...
                    goto not_priority_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\PriorityController::newAction',  '_route' => 'priority_new',);
            }
            not_priority_new:

            // priority_show
            if (preg_match('#^/priority/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_priority_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'priority_show')), array (  '_controller' => 'AppBundle\\Controller\\PriorityController::showAction',));
            }
            not_priority_show:

            // priority_edit
            if (preg_match('#^/priority/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_priority_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'priority_edit')), array (  '_controller' => 'AppBundle\\Controller\\PriorityController::editAction',));
            }
            not_priority_edit:
            ...
            if (preg_match('#^/priority/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'priority_delete')), array (  '_controller' => 'AppBundle\\Controller\\PriorityController::deleteAction',));
            }
            not_priority_delete:
